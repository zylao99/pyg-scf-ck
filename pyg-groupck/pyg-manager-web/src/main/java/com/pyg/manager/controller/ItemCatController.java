...
public class ItemCatController {
	 ...
	 * 返回值：List<tbItemCat>
	 */
	@RequestMapping("findCatList/{parentId}")
	public List<TbItemCat> findCatList(@PathVariable Long parentId){
		List<TbItemCat> catList = itemCatService.findCatList(parentId);
		return catList;
	}
}
